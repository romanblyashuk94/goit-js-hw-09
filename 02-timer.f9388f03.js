...
const dateInput = _flatpickrDefault.default("#datetime-picker", {
    enableTime: true,
    time_24hr: true,
    defaultDate: new Date(),
    minuteIncrement: 1,
    onClose (selectedDates) {
        if (selectedDates[0] <= Date.now()) _notiflixDefault.default.Notify.failure("Please choose a date in the future");
...
},{}]},["dgFMU","1AWyZ"], "1AWyZ", "parcelRequire7bc7")
